...
namespace gr
{
    public class Scene
    {
        ...
        internal gr.obj.MirrorMesh MirrorMesh { get; set; } = new gr.obj.MirrorMesh();
        ...
        private void RenderAllSingleThread(GraphicsDevice gd, CommandList cl, SceneContext sc)
        {
            ...
            Matrix4x4 planeReflectionMatrix = Matrix4x4.CreateReflection(gr.obj.MirrorMesh.Plane);
            CameraInfo camInfo = new CameraInfo();
            camInfo.CameraLookDirection = Vector3.Normalize(Vector3.Reflect(_camera.LookDirection, gr.obj.MirrorMesh.Plane.Normal));
